		...
		<div class="row justify-content-center upset shape-numm">
			<div class="col-lg-4 col-sm-6 shape-loc wow fadeInUp" data-wow-delay=".2s">
				<div class="office-card">
					<div class="skyline-img"> <img src="images/location/usa.webp" alt="USA" class="img-fluid" /> </div>
					<div class="office-text">
						<h4>USA</h4>
						<p>12316 SE 254th Ct Kent, WA 98030, United States</p>
						<a href="https://maps.app.goo.gl/f7ABczAUVGAKMT3k6" target="blank" class="btn-outline">View on Map
