			...
			<div class="row">
				<div class="col-lg-6">
					<div class="image-block upset">
					    <img src="images/hom-slider/1st.webp" alt="case study" class="img-fluid no-shadow" />
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-sm-6">
					<div class="project-view m-mt30">
					    <img src="images/hom-slider/2nd.webp" alt="case study" class="img-fluid" />
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="project-screens owl-carousel">
						<div class="screen-splits"> <img src=images/hom-slider/1.webp alt="case study" class="img-fluid" /></div>
						<div class="screen-splits"> <img src=images/hom-slider/2.webp alt="case study" class="img-fluid" /></div>
						<div class="screen-splits"> <img src=images/hom-slider/3.webp alt="case study" class="img-fluid" /></div>
						<div class="screen-splits"> <img src=images/hom-slider/4.webp alt="case study" class="img-fluid" /></div>
						<div class="screen-splits"> <img src=images/hom-slider/5.webp alt="case study" class="img-fluid" /></div>
						<div class="screen-splits"> <img src=images/hom-slider/6.webp alt="case study" class="img-fluid" /></div>
						<div class="screen-splits"> <img src=images/hom-slider/7.webp alt="case study" class="img-fluid" /></div>
					</div>
				</div>
			</div>
		</div>
