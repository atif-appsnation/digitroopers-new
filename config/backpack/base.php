...
return [
    ...
    */
    ...
    'project_logo'   => 'Digitroopers',

    // Show / hide breadcrumbs on admin panel pages.
    'breadcrumbs' => true,

    // Horizontal navbar classes. Helps make the admin panel look similar to your project's design.
    // 'header_class' => 'app-header bg-light  border-1 navbar',
    ...
    'developer_name' => 'futurealiti',

    // Developer website. Link in footer. Type false if you want to hide it.
    'developer_link' => 'futurealiti.com',
    ...
    */
    ...
    'body_class' => 'app aside-menu-fixed sidebar-lg-show',
    'sidebar_class' => 'sidebar bg-dark', // add "bg-white sidebar-pills" for light sidebar
